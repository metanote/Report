...
\title{Contexte des Réseaux sociaux Centralisés et décentralisés\\}
...
Tout d'abord \textit{QU'EST CE QU'UN RÉSEAU SOCIAL ?}\newline
...
Un utilitaire social comme Facebook, Google+ ou autres aident les gens à communiquer de manière plus efficace avec leurs amis, leur famille et leurs collègues. 
...
\textbf{\caption{Problem with today's social networks}}
\end{wrapfigure}
...
Deuxièmement ces sites ne permettent pas au utilisateurs de contrôler leurs données personnelles diffusés ce qui entraîne des problèmes de confidentialité potentiels. Finalement les données contrôler par la firme possessive des données au commerçant et puis c'est dernier il les revende au gouvernement dont il dépend, pour éspionner, réutiliser ... 
...
Le web actuelle est décentralisé mais il n'est pas distribué, en effet Il forme le cercle vicieux contournant autour les geant comme Google, Amazon ...
...
\newpage
\section{Conclusion \& Alternatives}
On commence par une petite interrogation\newline
...
Avec le team Stample souhaitent avoir deux versions une centralisé stable en changent l'ergonomie de l'apprentissage de l'utilisateur et en l'offrent des nouvelles fonctionnalités et puis quand on réussit à stabiliser la version décentralisé nous allons le lancer au grand publique.  
