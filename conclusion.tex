...
\paragraph{}
Ce stage m'a permis de consolider mes connaissances techniques et ma scalabilié.
...
J'ai eu des sous tâches pour les notifications, les commentaires .J'ai pu résoudre les problèmes des membres développeur coté frontend.
 \paragraph{}
En dors de Stampl,e j'ai enrichi mon Scala en suivant les cours sur Coursera et en faisant des exercices. Ces derniers sont disponibles \textit{sur mon compte GuitHub}\footnote{https://github.com/metanote}, pour deux raisons :
\begin{itemize}
\item La première d'apprendre les diffèrents outils du langage.
\item La deuxième pour améliorer mon Scala en s'adaptant à la porgrammation fonctionnelle.
\end{itemize}
...
\begin{itemize}
\item Un environnement technique totalement nouveau.
...
\item Je n'ai pas pu écrie aucune ligne de code dans le Linked Data plateforme.

\item J'ai seulement tester le Read Write Web play.
