...
\subparagraph{}
En dehors de Stample, j'ai appris Scala en suivant les cours sur Coursera\footnote{https://accounts.coursera.org/} et en faisant des exercices. Ces derniers sont disponibles \textit{sur mon compte GitHub}\footnote{https://github.com/metanote}, pour deux raisons :
\begin{itemize}
